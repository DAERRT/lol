        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarPath = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "/images/avatars/default.png"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectExchanges", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NecessaryResources = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Stack = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    EditComment = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExecutorProjectsId = table.Column<int>(type: "int", nullable: false),
                    ExecutorTeamsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectExecutors", x => new { x.ExecutorProjectsId, x.ExecutorTeamsId });
                    table.ForeignKey(
